...
export function DictionaryCard() {
  return (
    <Link
      href="/ai-dictionary"
      className="flex pointer-events-none border group border-border justify-between flex-col-reverse sm:flex-row items-center overflow-hidden hover:border-yellow-700"
    >
      <div className="p-5 flex flex-col items-start md:p-7 w-full">
        ...
        <span className="px-2 py-1 text-green-400 bg-muted mt-4">به زودی</span>
      </div>
