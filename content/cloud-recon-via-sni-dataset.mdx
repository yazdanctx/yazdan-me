...
>اینجا گفتم که سرور بر اساس مقدار `SNI`، سرتیفیکیت مناسبو برمیگردونه ولی اگه بخوام دقیق تر بگم، این رفتار همیشگی نیست و بعضی سرورها همیشه `Default Certificate` را برمیگردونن.
