...
اول میری رو یه کلون از این [ریپازیتوری](https://github.com/yazdanctx/kaeferyeager-sni-ip-sync) میگیری. داخل این ریپازیتوری یه اسکریپت گولنگ هست که میره `ipv4_merged_sni` هارو دانلود میکنه و همشونو میریزه داخل یدونه فایل تکست:
